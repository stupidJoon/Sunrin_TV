...
module.exports.addPublicSession = (code, caller, title, description) => {
  pool.query('INSERT INTO public_session (code, caller, title, description) VALUES (?, ?, ?, ?)', [code, caller, title, description]);
}
